...
As per [Issues Guidelines](https://gitlab.com/exadra37-docker/productivity-tool/go-for-it/blob/master/docs/how-to/create_an_issue.md) we do not need to have a Milestone for it.
...
As per [Issues Guidelines](https://gitlab.com/exadra37-docker/productivity-tool/go-for-it/blob/master/docs/how-to/create_an_issue.md) we must have a Milestone for this type of requirement.
